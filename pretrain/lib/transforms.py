...
class cfl_collate_fn_factory:
    ...
    def __call__(self, list_data):
        coords, feats, labels, coords1, feats1, labels1 = list(zip(*list_data))
        coords_batch, coords1_batch, feats_batch, labels_batch, feats_batch1, labels_batch1 = [], [], [], [], [], []
        ...
        for batch_id, _ in enumerate(coords):
            ...
            num_points1 = coords1[batch_id].shape[0]
        ...
        coords1_batch = torch.cat(coords1_batch, 0).int()
...
class btTransform:
    ...
    def __call__(self, list_data):
        ...
        coords1 = torch.cat((coords_batch[:, :1], coords1), 1)
        coords2 = torch.cat((coords_batch[:, :1], coords2), 1)

        return coords1, coords2, feats_batch, labels_batch
