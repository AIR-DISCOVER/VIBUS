...
net_arg.add_argument('--feature_dim', type=int, default=256, help='The dimension of features')
net_arg.add_argument(
    '--conv1_kernel_size', type=int, default=3, help='First layer conv kernel size')
net_arg.add_argument('--weights', type=str, default='/home/aidrive1/workspace/luoly/dataset/Min_scan/bt_train/log/120000/tmp_dir_scannet/weights.pth', help='Saved weights to load')
net_arg.add_argument(
...
data_arg.add_argument('--voxel_size', type=float, default=0.02)
