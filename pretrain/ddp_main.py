...
from lib.hack import occumpy_mem
...
def main():
    # for idx, device_id in enumerate(os.environ['CUDA_VISIBLE_DEVICES'].split(',')):
        # logging.log(logging.WARN, device_id)
        # occumpy_mem(int(device_id), idx)
    config = get_config()
    print('main')
