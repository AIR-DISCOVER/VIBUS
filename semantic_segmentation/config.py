...
data_arg.add_argument('--testdataset', type=str, default='')
...
data_arg.add_argument(
    '--semantic3d_path',
    type=str,
    default='/home/aidrive/luoly/datasets/semantic3d_preprocess/full',
    help='Scannet online voxelization dataset root dir')

data_arg.add_argument(
    '--semantic3d_test_path',
    type=str,
    default='/home/aidrive/luoly/datasets/semantic3d_preprocess/full',
    help='Scannet online voxelization dataset root dir')
...
data_arg.add_argument(
    '--stanford3d_path',
    type=str,
    default='/home/aidrive/luoly/datasets/S3DIS/semantic/full',
...
misc_arg.add_argument('--train_dataset', type=str, default='StanfordArea5Dataset')
misc_arg.add_argument('--val_dataset', type=str, default='StanfordArea5testDataset')
misc_arg.add_argument('--checkpoint_dir', type=str, default='/')
...
misc_arg.add_argument('--train_batch_size', type=int, default=2)
misc_arg.add_argument('--val_batch_size', type=int, default=2)
